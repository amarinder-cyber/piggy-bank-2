...
// Author name: <<Amarinder pal kaur>>
// account : <<0x319116aCc76260Df23E2f22F8B17FC195B94F527>>
...
contract PiggyBank2 {
    ...
    modifier onlyOwner() {
        require(msg.sender == owner, "You are not the owner of this piggy bank.");
        _;
    }
    ...
    function getConvertUsd() public view returns (uint) {
